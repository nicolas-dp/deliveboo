                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" v-model="password_confirm" v-on:keyup="checkPassword" :class="{'input_correct': password_check == 1, 'input_error': password_check == 2}">
                                </div>
                            </div>
