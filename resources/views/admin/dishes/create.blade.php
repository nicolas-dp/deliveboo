...
<div class="container-fluid py-5">
    ...
    <div class="container rounded my_shadow bg_black_trasparent p-5">
        ...
        <form action="{{ route('admin.dishes.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label class="my_yellow" for="name">Name*</label>
            ...
            <div class="mb-3">
                <label class="my_yellow" for="price">Price*</label>
            ...
            <div class="mb-3">
                <label class="my_yellow" for="ingredients">Ingredients</label>
            ...
            <div class="mb-3">
                <label class="my_yellow" for="is_available">Availability</label>
            ...
            <div class="mb-3">
                <label class="my_yellow" for="cover_image">Cover Image</label>
