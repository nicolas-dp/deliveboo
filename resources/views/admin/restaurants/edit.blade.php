        ...
        <form name="formRestaurant" action="{{ route('admin.restaurants.update', $restaurant->slug) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input required="required" type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                    placeholder="Pizzeria Mia" aria-describedby="nameHelper" value="{{ old('name', $restaurant->name) }}">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="address" id="address"
                    ...
                    aria-describedby="addressHelper" value="{{ old('address', $restaurant->address) }}">
            ...
            <div class="mb-2">
                ...
                <input type="time" min="13:00" max="23:59" name="closing_hours" id="closing_hours"
                    ...
                    value="{{ old('closing_hours', $restaurant->closing_hours) }}">
            ...
            <div class="mb-2">
                ...
                <input type="tel" name="PIVA" id="PIVA" maxlenght="11"
                    ...
                    aria-describedby="PIVAHelper" value="{{ old('PIVA', $restaurant->PIVA) }}">
