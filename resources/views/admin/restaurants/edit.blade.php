...
<div class="container pt-4 pb-5 ">
    ...
    <form name="formRestaurant" action="{{ route('admin.restaurants.update', $restaurant->slug) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            ...
            <input required="required" type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" v-model="rest_name" v-on:keyup="countCharRestName" :class="{'input_correct': rest_name_check == 1, 'input_error': rest_name_check == 2}" minlength="4" maxlength="50" placeholder="Pizzeria Mia" aria-describedby="nameHelper" value="{{ old('name', $restaurant->name) }}">
        ...
        <div class="mb-2">
            ...
            <input type="text" name="address" id="address" v-on:keyup="countCharAddress"  v-model="address" :class="{'input_correct': address_check == 1, 'input_error': address_check == 2}" class="form-control @error('address') is-invalid @enderror" placeholder="Via Rossa 34" aria-describedby="addressHelper" value="{{ old('address', $restaurant->address) }}">
        ...
        <div class="mb-2">
            ...
            <input type="tel" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" pattern="[0-9]{3}[-. ]?[0-9]{7}" 
            v-model="phone" v-on:keyup="countPhone" :class="{'input_correct': phone_check == 1, 'input_error': phone_check == 2}"
            placeholder="347-0000000" aria-describedby="phone_numberHelper" value="{{ old('phone_number', $restaurant->phone_number) }}">
        ...
        <div class="mb-2">
            ...
            <input type="time" min="05:00" max="13:00" name="opening_hours" id="opening_hours" class="form-control" placeholder="pippo" aria-describedby="opening_hoursHelper" value="{{ old('opening_hours', $restaurant->opening_hours) }}">
        ...
        <div class="mb-2">
            ...
            <input type="time" min="13:00" max="23:59" name="closing_hours" id="closing_hours" class="form-control" placeholder="pippo" aria-describedby="closing_hoursHelper" value="{{ old('closing_hours', $restaurant->closing_hours) }}">
        ...
        <div class="mb-2">
            ...
            <input type="number" step=".01" name="delivery_cost" id="delivery_cost" class="form-control @error('delivery_cost') is-invalid @enderror" placeholder="0.00"
            v-model="delivery_cost" v-on:keyup="checkDeliveryCost" :class="{'input_correct': delivery_cost_check == 1, 'input_error': delivery_cost_check == 2}"
        ...
        <div class="mb-2">
            ...
            <input type="tel" name="PIVA" id="PIVA" maxlenght="11" class="form-control @error('PIVA') is-invalid @enderror" pattern="[0-9]{11}" placeholder="inserisci un numero a 11 cifre" aria-describedby="PIVAHelper"  v-model="piva" v-on:keyup="countPIVA" :class="{'input_correct': piva_check == 1, 'input_error': piva_check == 2}" value="{{ old('PIVA', $restaurant->PIVA) }}">
